...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('traveler_pitch', models.CharField(default=None, max_length=250, null=True, blank=True)),
                ('profile_pic', sorl.thumbnail.fields.ImageField(upload_to=b'/images/profiles/profile_pics')),
                ('why_awesome', models.CharField(default=None, max_length=250, null=True, blank=True)),
                ('mission_statement', models.CharField(default=None, max_length=250, null=True, blank=True)),
                ...
                ('age', models.DateField(default=None, null=True, verbose_name=b'age', blank=True)),
                ('city', models.CharField(default=False, max_length=250, null=True, verbose_name=b'City', blank=True)),
