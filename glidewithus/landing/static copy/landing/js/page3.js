(function (a, c) {
    var b = a.PhoneNumberInputWidget = function (d) {
            this.init(d)
        };
    b.prototype = {
        prefix: null,
        ...
        setCountry: function (d) {
            this.$("select").find('option[value="' + d + '"]').attr("selected", "selected").change()
        },
        setNumber: function (d) {
            var e = this.getPrefix(),
                f = (d + "").replace(new RegExp("^" + e), "");
            this.$("input.pniw-number").val(f);
            this.updateHiddenField()
        },
        getNumber: function () {
            var e = this.getPrefix(),
                d = this.$("input.pniw-number").val();
            return c.trim(e + d)
        },
        getCountry: function () {
            return this.$("select").val()
        },
        countryChangeHandler: function (d, e) {
            var f = this.getCountry();
        ...
        setError: function (d) {
            this.$("input.pniw-number").toggleClass("error", d)
        },
        numberKeypressHandler: function (e, f) {
            var d = c(e);
            if (c.trim(d.val().length)) {
                this.setError(false)
            }
            if (f.which === 13) {
                return false
        ...
        numberChangeHandler: function (d, e) {
            this.updateHiddenField()
        },
        ...
        $: function (d, e) {
            if (e || typeof this.elements[d] === "undefined") {
                this.elements[d] = this.element.find(d)
            }
        ...
        proxy: function (e) {
            var d = this;
            return function (f) {
                return e.call(d, this, f)
            }
        }
    };
    c.fn.phoneNumberInputWidget = function () {
        return this.each(function (d, g) {
            var f = new b({
                element: g
            });
            c(this).data("phoneNumberInputWidget", f)
        })
    };
    c.phoneNumberInputWidget = function () {
        c("div.phone-number-input-widget").phoneNumberInputWidget()
    }
})(Cogzidel, jQuery);
(function (b, c) {
    var a = b.PhoneNumberVerifyWidget = function (d) {
            this.init(d)
        };
    a.prototype = {
        ...
        init: function (d) {
            ...
            if (d.element) {
                ...
                c.colorbox.loading();
                c.get(this.ajaxUrl, function (f) {
                    c.colorbox({
                        html: f
                    });
                    e.element = c("#colorbox .phone-number-add-widget");
                    e.initCallback()
                })
            }
        },
        ...
        setCountry: function (d) {
            this.phoneNumberInputWidget.setCountry(d)
        },
        setNumber: function (d) {
            this.phoneNumberInputWidget.setNumber(d)
        },
        getPrefix: function () {
        ...
        codeKeypressHandler: function (d, e) {
            if (e.which === 13) {
                this.$('.pnaw-verify-container a[rel="verify"]').click();
                return false
            }
        },
        cancelHandler: function (d, e) {
            this.finish(false);
            this.element.trigger("cancel")
        },
        verifyNumber: function (g, i, e) {
            var f = this,
                d = "/phone_numbers/create",
                g = c.trim(g),
                h = {
                    phone_number: g,
                    phone_type: e,
                    phone_number_country: i
                };
            this.setLoading(true);
            this.stepOneXhr = c.post(d, h, function (j) {
                f.setLoading(false);
                f.stepTwo();
                f.element.data("phone_number_id", j.phone_number_id)
            }).error(function () {
                f.setLoading(false);
                f.phoneNumberInputWidget.setError(true)
            })
        },
        stepOneHandler: function (e, g) {
            var h = this.getPrefix() + "",
                f = this.getNumber() + "",
                d = c(e).attr("rel"),
                i = this.getCountry();
            if (f === h) {
        ...
        stepTwoHandler: function () {
            var d = "/phone_numbers/verify",
                f = this.$("#phone_number_verification").val(),
                g = {
                ...
                e = this;
            e.setLoading(true);
            c.post(d, g, function (h) {
                e.setLoading(false);
                if (h.result === "success") {
                    e.finish();
                    e.$(".pnaw-verification-error").hide()
                } else {
                    e.$("#phone_number_verification").val("").animate({
                        left: "-5px"
                    }, 100, function () {
                        c(this).animate({
                            left: "5px"
                    ...
                    e.$(".pnaw-verification-error").fadeIn(200).text(h.error)
                }
            })
        },
        stepOne: function () {
        ...
        finish: function (d) {
            this.stepOne();
            if (this.options.onComplete && (typeof d === "undefined" || (typeof d !== "undefined" && d))) {
    ...
    c.fn.phoneNumberVerifyWidget = function () {
        return this.each(function (d, g) {
            var f = new a({
                element: g
            });
            c(this).data("phoneNumberVerifyWidget", f)
        })
    };
    c.phoneNumberVerifyWidget = function () {
        c("div.phone-number-add-widget").phoneNumberVerifyWidget()
    }
})(Cogzidel, jQuery);
(function (b, c) {
    var a = b.PhoneNumberWidget = function (e, d) {
            this.init(e, d)
        };
    a.prototype = {
        ...
        verifyCancelHandler: function (d, e) {
        ...
        onVerifyComplete: function () {
            ...
            if (this.options.onVerifyComplete) {
                d = this.options.onVerifyComplete.call(this)
            }
            if (d !== false) {
                e.element.addClass("loading");
                c.get(e.ajaxUrl, function (f) {
                    e.element.replaceWith(f);
        ...
        completeAddHandler: function (d, e) {
            this.$add.show();
            this.$addWidget.slideUp(200)
        },
        removeHandler: function (f, h) {
            var e = c(f),
                d = e.attr("href"),
                g = this;
            c.post(d);
            e.parents("tr").fadeOut(200, function () {
                c(this).remove();
                if (g.element.find("table.phone-numbers-table tr").length) {
                    g.element.addClass("has-phone-numbers")
                } else {
                    g.element.removeClass("has-phone-numbers")
                }
            });
            return false
        },
    ...
    c.fn.phoneNumberWidget = function (d) {
        return this.each(function (f, g) {
            new a(g, d)
        })
    };
    c.phoneNumberWidget = function (d) {
        c("div.phone-numbers-container").phoneNumberWidget(d)
    };
    b.PhoneNumberWidget = a
})(Cogzidel, jQuery);

function translate(a) {
    var b = jQuery("#new_translate_button").data("google-key");
    jQuery(".trans").each(function (d, f) {
        var e = jQuery(f);
        jQuery.ajax({
            url: "https://ajax.googleapis.com/ajax/services/language/translate?key=" + b + "&callback=?&v=1.0&langpair=%7C" + a,
            dataType: "json",
            data: {
                q: e.html()
            },
            ...
            type: "POST",
            success: function (c) {
                if (c && c.responseData && c.responseData.translatedText) {
                    e.html(c.responseData.translatedText)
                }
            }
        })
    })
...
var Page3 = {
    ...
    modal_log: function (a) {
        if (Statsd) {
            Statsd.increment("p3.modals." + a)
        }
    }
};
var page3Slideshow = {
...
function load_map_wrapper(a) {
    if (map_loaded) {
        ...
        (function () {
            ...
            b.async = true;
            b.src = document.location.protocol + "//maps.google.com/maps/api/js?v=3.5&sensor=false&callback=" + a + "&language=en";
...
var CogzidelRooms = {
    init: function (d) {
        ...
        function b() {
            if (window.FB && FB.Event && FB.Event.subscribe) {
                FB.Event.subscribe("edge.create", function (h) {
                    _gaq.push(["_trackSocial", "facebook", "like", h])
                });
                FB.Event.subscribe("edge.remove", function (h) {
                    _gaq.push(["_trackSocial", "facebook", "unlike", h])
                })
            }
        }
        if (window.FB) {
        ...
        if (d.otherHostingPrices) {
            jQuery("#my_other_listings").show();
            jQuery.each(d.otherHostingPrices, function (i, h) {
                jQuery("#hosting_" + i + "_nightly_price").html(h)
            })
        }
        if (d.videoProfile) {
            this.videoProfile = d.videoProfile;
        ...
        $(".twitter-share-button").click(function (h) {
            var i = this.href;
            if (Cogzidel.tweetHashTags) {
                i += encodeURIComponent(" " + Cogzidel.tweetHashTags)
            }
            popup(i, "fixed", 335, 500);
            h.preventDefault()
        })
    },
    ...
    contactMeHandler: function (b) {
        var a = this;
        this.loadContactLwlb()
    },
    loadContactLwlb: function () {
        var b = jQuery("#contact_wrapper"),
            a = this;
        ...
        jQuery("#lwlb_contact_container").load(ajax_lwlb_contact_url, null, function () {
            jQuery("#message_checkin").val(a.dateFormat);
            jQuery("#message_checkout").val(a.dateFormat);
    ...
    i.Picture.prototype = {
        ...
        add: function (z) {
            var w = 0,
                ...
                y = new Image(),
                u = function () {
                    e(y).load(x).attr("src", base_url+"images/no_image.jpg")
                },
                x = function () {
...
(function (a) {
    SimpleStateMachine = function (b, c) {
        var d = this;
        d.init(b, c)
    };
    SimpleStateMachine.prototype.currentState = 0;
    a.extend(SimpleStateMachine.prototype, {
        States: {
            Init: 0
        },
        options: {},
        init: function (b, c) {
            ...
            a.each(d.States, function (f, e) {
                a.each(d.States, function (h, g) {
                    d.transitions[e + "_" + g] = []
                });
        ...
        addTransitionHandler: function (d, b) {
            var c = this;
            var g = "";
            if (typeof d === "object") {
                var f = d.from == null ? "" : d.from;
...
(function (c, b) {
    var a = c.VerificationFlow = function (d) {
    ...
    a.prototype = {
        ...
        init: function () {
            ...
            b.each(this.transitionHandlers, function (h, i) {
                var j = d.states[h];
                d.sm.addTransitionHandler(j, i)
            });
            for (var f = this.currentState; f < this.numStates; f++) {
            ...
            if (this.options.showIntro) {
                var e = this.$(".verification-flow-intro").show(),
                    g = this.$(".verification-flow-panels").hide();
                this.$("a.start").click(function () {
                    e.hide();
                    g.show();
                    d.start()
                });
                d.trackEvent("show_intro", {
                    numSteps: d.steps.length,
                    steps: d.steps
                })
            } else {
                d.start()
        ...
        submitHandlers: {
            basic_profile: function (f) {
                if (b.trim(b("#user_profile_info_about").val()) === "") {
                    this.showError("You need to enter a profile description!")
                } else {
                    var e = this.$panel("basic_profile").find("textarea"),
                        d = {};
                    d[e.attr("name")] = e.val();
                    b.post(e.attr("data-url"), d);
                    f.call(this)
                }
            },
            phone_verification: function (d) {
            ...
            profile_photo: function (e) {
                var d = this;
                d.setLoading(true);
                b.getJSON("/users/has_profile_pic", function (f) {
                    d.setLoading(false);
                    if (f.has_profile_pic) {
                        e.call(d)
                    } else {
                        d.showError("You need to add a profile photo before continuing.")
                    }
                })
            },
            real_name: function (d) {
        ...
        nextState: function () {
            var d = this,
                g = this.statesFlipped[this.currentState],
                h = this.submitHandlers[g],
                f;
            for (var e = this.currentState; e < this.numStates; e++) {
                f = e + 1;
                if (this.$panel(this.statesFlipped[f]).length) {
                    break
                }
            }
            if (this.$panel(g).length) {
                h.call(this, j)
            } else {
                j()
            }
            function j() {
                this.trackEvent("step_completed." + g);
                if (f === d.numStates) {
                    d.finish()
                } else {
                    d.currentState = f;
                    d.sm.transitionTo(d.currentState);
                    d.updateStep()
                }
            }
        },
        updateStep: function () {
            var f = this.$(".verification-flow-panel:visible"),
                e = f.index() === -1 ? 1 : f.index() + 1,
                d = this.statesFlipped[this.currentState];
            this.$(".verification-flow-step span:first").text(e);
            if (e === this.$(".verification-flow-panel").length) {
                this.$continue.text(a.translations.finish)
            }
            this.trackEvent("step_start." + d)
        },
        $: function (d) {
            return this.element.find(d)
        },
        $panel: function (d) {
            return this.$(".verification-flow-panel." + d)
        },
        finish: function () {
        ...
        initRealName: function () {
            var d = this,
                e = this.$panel("real_name"),
                f;
            if (!e.length) {
                return
            }
            e.addClass("loading");
            this.realNameFlow = new c.RealNameFlow({
                form: false,
                container: e,
                onLoad: function () {
                    e.removeClass("loading");
                    f = b("#real_name_flow .form_submit .button-glossy.submit").removeClass("green").addClass("blue");
                    if (d.steps.length > 1) {
                        f.text(a.translations.finish)
                    }
                    if (d.statesFlipped[d.currentState] === "real_name") {
                        d.$continue.hide()
                    }
                },
                onSuccess: function () {
                    d.hasCompletedRealName = true;
                    d.nextState()
                }
            })
        },
        trackEvent: function (e, d) {
            var f = "verification_flow.";
            Mixpanel.track(f + e, d)
        }
    };
    a.translations = {
        finish: "Finish"
    };
    a.addTranslations = function (d) {
        b.extend(a.translations, d)
    };
    b.fn.verificationFlow = function (e) {
        e = b.extend({}, e || {}, {
            element: this
        });
        var d = new c.VerificationFlow(e);
        b(this).data("verificationFlow", d)
    }
